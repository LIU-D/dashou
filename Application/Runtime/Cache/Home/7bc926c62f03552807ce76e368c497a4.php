	        	...
	        	<div class="row">
	        		<div class="col-xs-12">
	        			<div class="banner-heading">
	        				<h1 class="banner-title">Clients Reviews</h1>
	        			</div>
			        	<ul class="breadcrumb">
			            <li>Home</li>
			            <li>Company Pages</li>
	...
	<section id="main-container" class="main-container">
		<div class="container">
			<div class="row text-center">
				<h2 class="title">
					We are Helpful
					<span class="title-head">What Client Says</span>
				</h2>
			</div><!--/ Title row end -->
			...
			<div class="row">
				...
				<div class="col-md-6 col-sm-6">
					<div class="testimonial-classic">
						...
						<p class="testimonial-classic-text">Lorem Ipsum as their default model text, and a search for ‘lorem ipsum’ will uncover many web sites still in their infancy. Various versions have evolved over the years, sometimes by accident, sometimes on purpose. Lorem Ipsum is that it as opposed to using.Generators on the Internet tend to repeat predefined chunks as necessary, making this the first true evere generator on the Internet. It uses a dictionary of over 200 Latin words, combined with generate Lorem Ipsum which looks reasonable.</p>
						<div class="testimonial-classic-author">
							<h3 class="name">John Anderson</h3>
							<h4 class="desg">General Manager</h4>
						</div>
					</div><!-- Testimonial content end -->
				</div><!-- End col-md-6 -->
			...
			<div class="row">
				<div class="col-md-4 col-sm-6">
					<div class="testimonial-classic">
						<img src="/dashou/Public/Home/images/clients/testimonial1.png" alt="testimonial">
						<p class="testimonial-classic-text">Lorem Ipsum as their default model text, and a search for ‘lorem ipsum’ will uncover many web sites still in their infancy. Various versions have evolved over the years, sometimes by accident, sometimes on purpose.</p>
						<div class="testimonial-classic-author">
							<h3 class="name">Tahlia Bidmead</h3>
							<h4 class="desg">Chief Operation Officer</h4>
						</div>
				...
				<div class="col-md-4 col-sm-6">
					<div class="testimonial-classic">
						<img src="/dashou/Public/Home/images/clients/testimonial3.png" alt="testimonial">
						<p class="testimonial-classic-text">Lorem Ipsum as their default model text, and a search for ‘lorem ipsum’ will uncover many web sites still in their infancy. Various versions have evolved over the years, sometimes by accident, sometimes on purpose.</p>
						<div class="testimonial-classic-author">
							<h3 class="name">John Anderson</h3>
							<h4 class="desg">General Manager</h4>
