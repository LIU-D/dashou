...
<body>
	...
	<div id="banner-area" class="banner-area" style="background-image:url(/dashou/Public/Home/images/banner/banner6.jpg)">
		<!-- Subpage title start -->
	        	...
	        	<div class="row">
	        		<div class="col-xs-12">
	        			<div class="banner-heading">
									<h1 class="banner-title">站点查询</h1>
	        			</div>
			        	<ul class="breadcrumb">
			            <li><a href="<?php echo U('Index/index');?>">首页</a></li>
			            <li>服务中心</li>
			            <li><a href="<?php echo U('Index/call');?>">站点查询</a></li>
		          	</ul>
	        		</div>
	        	</div>
       	</div>
