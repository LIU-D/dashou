...
<link href="/dashou/Public/Home/css/style.css" rel="stylesheet" type="text/css" media="all" />
<!-- <link href='http://fonts.googleapis.com/css?family=Exo+2' rel='stylesheet' type='text/css'> -->
<script type="text/javascript" src="/dashou/Public/Home/js/jquery1.min.js"></script>
<!-- start menu -->
<link href="/dashou/Public/Home/css/megamenu.css" rel="stylesheet" type="text/css" media="all" />
<script type="text/javascript" src="/dashou/Public/Home/js/megamenu.js"></script>
<script>$(document).ready(function(){$(".megamenu").megamenu();});</script>
<script src="/dashou/Public/Home/js/jquery.easydropdown.js"></script>
</head>
<body>
	...
	<div class="header-bottom">
		<div class="wrap">
			<div class="header-bottom-left">
				<div class="logo">
					<a href="index.html"><img src="/dashou/Public/Home/images/logo.png" alt=""/></a>
				</div>
				<div class="menu">
