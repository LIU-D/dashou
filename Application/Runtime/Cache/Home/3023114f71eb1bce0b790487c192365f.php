		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-12">
					<h2 class="title">
						Historical business
						<span class="title-head">历史业务</span>
					</h2>
				</div>

				<?php if(is_array($policy_list)): foreach($policy_list as $key=>$policy): ?><div  class="col-md-12" style="min-height: 200px;background-image:url(/dashou/Public/Home/images/banner/banner<?php echo ($key+1); ?>.jpg)">
					<div class="banner-text text-center">
						<div class="container">
						   <div class="row">
							   <div class="col-xs-12">
