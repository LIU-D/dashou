	        	...
	        	<div class="row">
	        		<div class="col-xs-12">
	        			<div class="banner-heading">
	        				<h1 class="banner-title">Elements</h1>
	        			</div>
			        	<ul class="breadcrumb">
			            <li>Home</li>
			            <li>Features</li>
	...
	<section id="main-container" class="main-container">
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-6">
					<h3 class="title-normal">Accordion</h3>
		         ...
		         <h3>Facts</h3>
					...
					<div class="ts_counter elements no-padding">
						<div class="row text-center">
							<div class="ts-facts-wrapper">
								<div class="ts-facts">
									<div class="ts-facts-icon">
										<i class="fa fa-line-chart"></i>
									</div>
									<div class="ts-facts-content">
										<h2 class="ts-facts-num"><span class="counterUp">1705</span></h2>
				...
				<div class="col-md-6">
						  	...
						  	<li class="active">
						  		<a class="animated fadeIn" href="#tab_a" data-toggle="tab">
						  			<span class="tab-head">
										...
										<span class="tab-text-title">Section 1</span>					
									</span>
						  		</a>
						  	</li>
						  	<li>
							  	<a class="animated fadeIn" href="#tab_b" data-toggle="tab">
							  		<span class="tab-head">
										...
										<span class="tab-text-title">Section 2</span>					
									</span>
							  	</a>
							</li>
						 	<li>
							  	<a class="animated fadeIn" href="#tab_c" data-toggle="tab">
							  		<span class="tab-head">
										...
										<span class="tab-text-title">Section 3</span>					
									</span>
							  	</a>
							</li>
						...
						<div class="tab-content col-sm-12 col-xs-12">
					        <div class="tab-pane active animated fadeInRight" id="tab_a">
					        	<div class="tab-wrapper">
						         ...
						         <p>None quis nibh vel erat tincidunt pretium. In sit amet massa sapien. Vestibulum diam turpis, gravida in lobortis id, ornare a eros. Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
		    		...
		    		<div class="testimonial-classic">
						...
						<p class="testimonial-classic-text">Lorem Ipsum as their default model text, and a search for ‘lorem ipsum’ will uncover many web sites still in their infancy. Various versions have evolved over the years, sometimes by accident.</p>
				...
				<div class="col-md-6">
					...
					<div class="ts-service-wrapper">
						...
						<div class="ts-service-info">
							...
							<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer suscipit congue turpis nec finibus.</p>
						</div>
					</div>
				</div>
