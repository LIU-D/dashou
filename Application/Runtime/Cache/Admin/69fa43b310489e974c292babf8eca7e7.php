...
<footer class="footer mt-20">
	<div class="container">
		<p>感谢jQuery、layer、laypage、Validform、UEditor、My97DatePicker、iconfont、Datatables、WebUploaded、icheck、highcharts、bootstrap-Switch<br>
			Copyright &copy;HLZ All Rights Reserved.<br>
			本后台系统由<a href="http://www.hbun.net/" target="_blank" title="HLZ">HLZ</a>提供技术支持</p>
			<p>More Templates <a href="http://www.hbun.net/" target="_blank" title="HLZ">HLZ</a> - Collect from <a href="http://www.hbun.net/" title="后台" target="_blank">后台</a></p>
	</div>
</footer>
