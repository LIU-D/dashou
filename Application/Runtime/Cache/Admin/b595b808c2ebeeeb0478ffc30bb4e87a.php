...
<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
		...
		<dl id="menu-admin">
			...
			<dd>
				<ul>
					<li><a data-href="<?php echo U('Message/index');?>" data-title="在线留言" href="javascript:void(0)">在线留言</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-admin">
			...
			<dd>
				<ul>
					<li><a data-href="<?php echo U('User/index');?>" data-title="角色管理" href="javascript:void(0)">角色管理</a></li>
				</ul>
			</dd>
		</dl>
</div>
