...
<div class="page-container">
	...
	<div class="mt-20">
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			...
			<tbody>
			<?php if(is_array($insurance_list)): foreach($insurance_list as $key=>$insurance): ?><tr class="text-c">
					...
					<td class="td-status">
						...
						<?php elseif($insurance["insurance_isdel"] == '未发布' ): ?>
							<span class="label label-dafault radius"><?php echo ($insurance["insurance_isdel"]); ?></span>
						<?php else: ?>
