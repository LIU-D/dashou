...
<article class="page-container">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="<?php echo ($join['user_phone']); ?>" placeholder="" id="phone" name="phone" disabled>
		</div>
	</div>
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<textarea style="height:300px" name="" cols="" rows="" class="textarea" dragonfly="true" disabled><?php echo ($join['join_content']); ?></textarea>
		</div>
	</div>
